...
***REMOVED***,
***REMOVED******REMOVED***{
***REMOVED******REMOVED***"name": "image_mapping",
***REMOVED******REMOVED***"type": "Edm.String",
***REMOVED******REMOVED***"searchable": False,
***REMOVED******REMOVED***"sortable": False,
***REMOVED******REMOVED***"facetable": False,
***REMOVED******REMOVED***"filterable": False
***REMOVED***
...
***REMOVED***parser.add_argument("--form-rec-use-layout", default=True, action='store_true', help="Whether to use Layout model for PDF cracking, if False will use Read model.")
...
***REMOVED***parser.add_argument("--azure-openai-endpoint", type=str, help="Endpoint for the (Azure) OpenAI API. Format: 'https://<AOAI resource name>.openai.azure.com/openai/deployments/<vision model name>/chat/completions?api-version=2024-04-01-preview'")
***REMOVED***parser.add_argument("--azure-openai-key", type=str, help="Key for the (Azure) OpenAI API.")
...
***REMOVED******REMOVED***form_recognizer_client = DocumentIntelligenceClient(endpoint=f"https://{args.form_rec_resource}.cognitiveservices.azure.com/", credential=AzureKeyCredential(args.form_rec_key))
...
***REMOVED***
***REMOVED***create_index(index_config, credential, form_recognizer_client, embedding_model_endpoint=args.embedding_model_endpoint, use_layout=args.form_rec_use_layout, njobs=args.njobs, captioning_model_endpoint=args.azure_openai_endpoint, captioning_model_key=args.azure_openai_key)
