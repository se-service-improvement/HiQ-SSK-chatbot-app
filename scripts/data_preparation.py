...
***REMOVED***if config.get("vector_config_name") and os.environ.get("EMBEDDING_MODEL_ENDPOINT") and os.environ.get("EMBEDDING_MODEL_KEY"):
...
***REMOVED***if index_config.get("vector_config_name") and not (args.embedding_model_endpoint and args.embedding_model_key):
