...
***REMOVED***  `python data_preparation.py --config config.json --embedding-model-endpoint "<embedding endpoint>"`
...
***REMOVED***"chunk_size": 1024,
***REMOVED***"token_overlap": 128,
***REMOVED***"keyvault_url": "https://<keyvault name>.vault.azure.net/",
***REMOVED***"document_intelligence_secret_name": "myDocIntelligenceKey",
***REMOVED***"document_intelligence_endpoint": "https://<document intelligence resource name>.cognitiveservices.azure.com/",
***REMOVED***"embedding_key_secret_name": "myAzureOpenAIKey",
***REMOVED***"embedding_endpoint": "https:/<azure openai resource name>.openai.azure.com/openai/deployments/<Ada deployment name>/embeddings?api-version=2023-06-01-preview",
***REMOVED***"index_name": "<new index name>",
***REMOVED***"search_service_name": "<search service name>",
***REMOVED***"search_key_secret_name": "mySearchServiceKey"
}
```
