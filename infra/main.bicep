...
***REMOVED***authIssuerUri: authIssuerUri
***REMOVED***appSettings: {
***REMOVED***  // search
...
***REMOVED***  version: '0613'
***REMOVED***
***REMOVED***capacity: 30
  ***REMOVED***
***REMOVED***  {
***REMOVED***name: embeddingDeploymentName
***REMOVED***model: {
***REMOVED***  format: 'OpenAI'
***REMOVED***  name: embeddingModelName
***REMOVED***  version: '2'
***REMOVED***
***REMOVED***capacity: 30
  ***REMOVED***
...
module cosmos 'db.bicep' = {
  ...
  scope: resourceGroup
  params: {
***REMOVED***accountName: !empty(cosmosAccountName) ? cosmosAccountName : '${abbrs.documentDBDatabaseAccounts}${resourceToken}'
***REMOVED***location: resourceGroup.location
***REMOVED***tags: tags
***REMOVED***principalIds: [principalId, backend.outputs.identityPrincipalId]
  }
}
