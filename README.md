...
***REMOVED***These variables are required when adding your data:
...
***REMOVED***- `AZURE_OPENAI_EMBEDDING_ENDPOINT`
***REMOVED***- `AZURE_OPENAI_EMBEDDING_KEY`
...
***REMOVED***<img
***REMOVED***src={Azure}
***REMOVED***className={styles.chatIcon}
***REMOVED***aria-hidden="true"
***REMOVED***/>
***REMOVED***<h1 className={styles.chatEmptyStateTitle}>Start chatting</h1>
***REMOVED***<h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer your questions</h2>
</Stack>
```
...
***REMOVED***if (citation.url) {
***REMOVED******REMOVED***window.open(citation.url, "_blank");
***REMOVED***
***REMOVED***;

<span 
***REMOVED***title={activeCitation.url} 
***REMOVED***tabIndex={0} 
***REMOVED***role="link" 
***REMOVED***onClick={() => onViewSource(activeCitation)} 
***REMOVED***onKeyDown={e => e.key === "Enter" || e.key === " " ? onViewSource(activeCitation) : null}
***REMOVED***className={styles.viewSourceButton}
***REMOVED***aria-label={activeCitation.url}
***REMOVED***>
***REMOVED***View Source
</span>
```
