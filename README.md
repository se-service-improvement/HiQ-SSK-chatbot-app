...
***REMOVED***
***REMOVED***These variables are required:
***REMOVED***- `AZURE_OPENAI_RESOURCE` or `AZURE_OPENAI_ENDPOINT`
***REMOVED***- `AZURE_OPENAI_MODEL`
***REMOVED***- `AZURE_OPENAI_KEY` (optional if using Entra ID)

***REMOVED***These variables are optional:
***REMOVED***- `AZURE_OPENAI_TEMPERATURE`
***REMOVED***- `AZURE_OPENAI_TOP_P`
***REMOVED***- `AZURE_OPENAI_MAX_TOKENS`
***REMOVED***- `AZURE_OPENAI_STOP_SEQUENCE`
...
***REMOVED***These variables are required when adding your data with Azure AI Search:
***REMOVED***- `DATASOURCE_TYPE` (should be set to `AzureCognitiveSearch`)
***REMOVED***- `AZURE_SEARCH_SERVICE`
***REMOVED***- `AZURE_SEARCH_INDEX`
***REMOVED***- `AZURE_SEARCH_KEY` (optional if using Entra ID)

***REMOVED***These variables are optional:
***REMOVED***- `AZURE_SEARCH_USE_SEMANTIC_SEARCH`
***REMOVED***- `AZURE_SEARCH_SEMANTIC_SEARCH_CONFIG`
***REMOVED***- `AZURE_SEARCH_INDEX_TOP_K`
***REMOVED***- `AZURE_SEARCH_ENABLE_IN_DOMAIN`
***REMOVED***- `AZURE_SEARCH_CONTENT_COLUMNS`
***REMOVED***- `AZURE_SEARCH_FILENAME_COLUMN`
***REMOVED***- `AZURE_SEARCH_TITLE_COLUMN`
***REMOVED***- `AZURE_SEARCH_URL_COLUMN`
***REMOVED***- `AZURE_SEARCH_VECTOR_COLUMNS`
***REMOVED***- `AZURE_SEARCH_QUERY_TYPE`
***REMOVED***- `AZURE_SEARCH_PERMITTED_GROUPS_COLUMN`
***REMOVED***- `AZURE_SEARCH_STRICTNESS`
